...
inline __device__ __host__ double dmax(double a, double b)
{
  return a > b ? a : b;
}

inline __device__ __host__ double dmin(double a, double b)
{
  return a < b ? a : b;
}
...
// min
static __inline__ __host__ __device__ double3 dmin(double3 a, double3 b)
{
	return make_double3( dmin(a.x,b.x), dmin(a.y,b.y), dmin(a.z,b.z) );
}

// max
static __inline__ __host__ __device__ double3 dmax(double3 a, double3 b)
{
...
inline __host__ __device__ double3 operator*(double3 a, double s)
{
    return make_double3(a.x * s, a.y * s, a.z * s);
}
inline __host__ __device__ double3 operator*(double s, double3 a)
{
    return make_double3(a.x * s, a.y * s, a.z * s);
}
inline __host__ __device__ void operator*=(double3 &a, double s)
{
    a.x *= s; a.y *= s; a.z *= s;
}
