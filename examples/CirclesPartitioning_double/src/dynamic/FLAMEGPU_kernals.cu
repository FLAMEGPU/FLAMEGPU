...
/*
 * get first spatial partitioned location message (first batch load into shared memory)
 */
...
/*
 * get next spatial partitioned location message (either from SM or next batch load)
 */
