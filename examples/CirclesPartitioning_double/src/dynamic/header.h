...
struct __align__(16) xmachine_memory_Circle
{
    ...
    double z;    /**< X-machine memory variable z of type double.*/
    double fx;    /**< X-machine memory variable fx of type double.*/
    double fy;    /**< X-machine memory variable fy of type double.*/
};
...
{	
    ...
    double x;        /**< Message variable x of type double.*/  
    double y;        /**< Message variable y of type double.*/  
    double z;        /**< Message variable z of type double.*/
};
...
{	
    ...
    double x [xmachine_memory_Circle_MAX];    /**< X-machine memory variable list x of type double.*/
    double y [xmachine_memory_Circle_MAX];    /**< X-machine memory variable list y of type double.*/
    double z [xmachine_memory_Circle_MAX];    /**< X-machine memory variable list z of type double.*/
    double fx [xmachine_memory_Circle_MAX];    /**< X-machine memory variable list fx of type double.*/
    double fy [xmachine_memory_Circle_MAX];    /**< X-machine memory variable list fy of type double.*/
};
...
struct xmachine_message_location_list
{
    ...
    double x [xmachine_message_location_MAX];    /**< Message memory variable list x of type double.*/
    double y [xmachine_message_location_MAX];    /**< Message memory variable list y of type double.*/
    double z [xmachine_message_location_MAX];    /**< Message memory variable list z of type double.*/
 ...
 */
__FLAME_GPU_FUNC__ int inputdata(xmachine_memory_Circle* agent, xmachine_message_location_list* location_messages, xmachine_message_location_PBM* partition_matrix);
 ...
 * @param x	message variable of type double
 * @param y	message variable of type double
 * @param z	message variable of type double
 */
 
 __FLAME_GPU_FUNC__ void add_location_message(xmachine_message_location_list* location_messages, int id, double x, double y, double z);
 ...
 * @param x	agent agent variable of type double
 * @param y	agent agent variable of type double
 * @param z	agent agent variable of type double
 * @param fx	agent agent variable of type double
 * @param fy	agent agent variable of type double
 */
__FLAME_GPU_FUNC__ void add_Circle_agent(xmachine_memory_Circle_list* agents, int id, double x, double y, double z, double fx, double fy);
