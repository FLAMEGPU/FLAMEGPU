...
void Circle_inputdata(cudaStream_t &stream){
	...
	h_tex_xmachine_message_location_x_offset = (int)tex_xmachine_message_location_x_byte_offset / sizeof(double);
	...
	h_tex_xmachine_message_location_y_offset = (int)tex_xmachine_message_location_y_byte_offset / sizeof(double);
	...
	h_tex_xmachine_message_location_z_offset = (int)tex_xmachine_message_location_z_byte_offset / sizeof(double);
  ...
  h_tex_xmachine_message_location_pbm_end_or_count_offset = (int)tex_xmachine_message_location_pbm_end_or_count_byte_offset / sizeof(int);
	...
	//Output       : 
	//Agent Output : 
	GPUFLAME_inputdata<<<g, b, sm_size, stream>>>(d_Circles, d_locations, d_location_partition_matrix);
	gpuErrchkLaunch();
