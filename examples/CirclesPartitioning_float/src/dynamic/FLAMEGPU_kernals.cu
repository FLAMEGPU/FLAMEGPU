...
__device__ void add_Circle_agent(xmachine_memory_Circle_list* agents, int id, float x, float y, float z, float fx, float fy){
 ...
 * @param z agent variable of type float
 */
__device__ void add_location_message(xmachine_message_location_list* messages, int id, float x, float y, float z){
