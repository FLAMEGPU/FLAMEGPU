...
#define INITIAL_EMISSION_RATE_EXIT1	10.f
#define INITIAL_EMISSION_RATE_EXIT2	10.f
#define INITIAL_EMISSION_RATE_EXIT3	10.f
#define INITIAL_EMISSION_RATE_EXIT4	10.f
#define INITIAL_EMISSION_RATE_EXIT5	10.f
#define INITIAL_EMISSION_RATE_EXIT6	10.f
#define INITIAL_EMISSION_RATE_EXIT7	10.f
