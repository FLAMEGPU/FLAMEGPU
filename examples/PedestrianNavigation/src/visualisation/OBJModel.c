...
void allocateObjModel(int vertex_count, int face_count, float3** vertices, float3** normals, int3** faces){
	*vertices = (float3*)malloc(vertex_count*sizeof(float3));
	*normals = (float3*)malloc(vertex_count*sizeof(float3));
	*faces = (int3*)malloc(face_count*sizeof(int3));
}
...
void xAllocateObjModel(int vertex_count, int normal_count, int face_count, float3** vertices, float3** normals, int4** faces){
	*vertices = (float3*)malloc(vertex_count*sizeof(float3));
	*normals = (float3*)malloc(normal_count*sizeof(float3));
	*faces = (int4*)malloc(face_count*sizeof(int4));
}
