...
__global__ void output_cell_agent_to_VBO(xmachine_memory_cell_list* agents, float4* vbo, float3 centralise, int population_width){
...
void initVisualisation()
{
	...
	// create TBO
	createTBO( &cell_default_tbo, &cell_default_displacementTex, xmachine_memory_cell_MAX * sizeof( float4));
