            ...
            if(in_vertices &amp;&amp; in_vertex){
                <xsl:for-each select="gpu:vertex/xmml:variables/gpu:variable">if(in_vertex_<xsl:value-of select="xmml:name"/>){
                    <xsl:choose>
                        <xsl:when test="xmml:arrayLength">
                            <xsl:choose>
                                <xsl:when test="contains(xmml:type, '2')">readArrayInputVectorType&lt;<xsl:value-of select="xmml:type"/>, <xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, 2&gt;(&amp;<xsl:call-template name="typeParserFunc"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, buffer, vertex_<xsl:value-of select="xmml:name"/>, <xsl:value-of select="xmml:arrayLength"/>);</xsl:when>
                                <xsl:when test="contains(xmml:type, '3')">readArrayInputVectorType&lt;<xsl:value-of select="xmml:type"/>, <xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, 3&gt;(&amp;<xsl:call-template name="typeParserFunc"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, buffer, vertex_<xsl:value-of select="xmml:name"/>, <xsl:value-of select="xmml:arrayLength"/>);</xsl:when>
                                <xsl:when test="contains(xmml:type, '4')">readArrayInputVectorType&lt;<xsl:value-of select="xmml:type"/>, <xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, 4&gt;(&amp;<xsl:call-template name="typeParserFunc"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, buffer, vertex_<xsl:value-of select="xmml:name"/>, <xsl:value-of select="xmml:arrayLength"/>);</xsl:when>
                                <xsl:otherwise>readArrayInput&lt;<xsl:value-of select="xmml:type"/>&gt;(&amp;<xsl:call-template name="typeParserFunc"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, buffer, vertex_<xsl:value-of select="xmml:name"/>, <xsl:value-of select="xmml:arrayLength"/>);</xsl:otherwise>
                            </xsl:choose>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:choose>
                                <xsl:when test="contains(xmml:type, '2')">readArrayInput&lt;<xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>&gt;(&amp;<xsl:call-template name="typeParserFunc"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, buffer, (<xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>*)&amp;vertex_<xsl:value-of select="xmml:name"/>, 2); </xsl:when>
                                ...
                                <xsl:when test="contains(xmml:type, '4')">readArrayInput&lt;<xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>&gt;(&amp;<xsl:call-template name="typeParserFunc"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, buffer, (<xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>*)&amp;vertex_<xsl:value-of select="xmml:name"/>, 4);</xsl:when>
                ...
                <xsl:for-each select="gpu:edge/xmml:variables/gpu:variable">if(in_edge_<xsl:value-of select="xmml:name"/>){
                    <xsl:choose>
                        <xsl:when test="xmml:arrayLength">
                            <xsl:choose>
                                <xsl:when test="contains(xmml:type, '2')">readArrayInputVectorType&lt;<xsl:value-of select="xmml:type"/>, <xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, 2&gt;(&amp;<xsl:call-template name="typeParserFunc"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, buffer, edge_<xsl:value-of select="xmml:name"/>, <xsl:value-of select="xmml:arrayLength"/>);</xsl:when>
                                <xsl:when test="contains(xmml:type, '3')">readArrayInputVectorType&lt;<xsl:value-of select="xmml:type"/>, <xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, 3&gt;(&amp;<xsl:call-template name="typeParserFunc"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, buffer, edge_<xsl:value-of select="xmml:name"/>, <xsl:value-of select="xmml:arrayLength"/>);</xsl:when>
                                <xsl:when test="contains(xmml:type, '4')">readArrayInputVectorType&lt;<xsl:value-of select="xmml:type"/>, <xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, 4&gt;(&amp;<xsl:call-template name="typeParserFunc"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, buffer, edge_<xsl:value-of select="xmml:name"/>, <xsl:value-of select="xmml:arrayLength"/>);</xsl:when>
                                <xsl:otherwise>readArrayInput&lt;<xsl:value-of select="xmml:type"/>&gt;(&amp;<xsl:call-template name="typeParserFunc"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, buffer, edge_<xsl:value-of select="xmml:name"/>, <xsl:value-of select="xmml:arrayLength"/>);</xsl:otherwise>
                            </xsl:choose>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:choose>
                                <xsl:when test="contains(xmml:type, '2')">readArrayInput&lt;<xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>&gt;(&amp;<xsl:call-template name="typeParserFunc"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, buffer, (<xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>*)&amp;edge_<xsl:value-of select="xmml:name"/>, 2); </xsl:when>
                                ...
                                <xsl:when test="contains(xmml:type, '4')">readArrayInput&lt;<xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>&gt;(&amp;<xsl:call-template name="typeParserFunc"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>, buffer, (<xsl:call-template name="vectorBaseType"><xsl:with-param name="type" select="xmml:type"/></xsl:call-template>*)&amp;edge_<xsl:value-of select="xmml:name"/>, 4);</xsl:when>
